<button class="btn btn-sm light-background mt-2" data-bs-toggle="modal"
                                    data-bs-target="#addSubCategoryModal_{{ $category->id }}"><b>Add SubCategory</b></button>

                                    <div class="modal fade" id="addSubCategoryModal_{{ $category->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ url('create-subcategory/'.$category->id) }}" method="post">
                        @csrf
